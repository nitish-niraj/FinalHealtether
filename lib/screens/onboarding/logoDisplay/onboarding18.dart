...
import 'package:finalhealtether/screens/onboarding/logoDisplay/Onboarding%2019.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class onbording18 extends StatefulWidget {
  const onbording18({super.key});

  @override
  State<onbording18> createState() => _onbording18State();
}

class _onbording18State extends State<onbording18> {
  @override
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
             children: [
               Image.asset('assets/images/Vector 337.png',height:  543*he,width: 1265*wi,
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>onbording19()));
                },
              ),
            ),
          ],
