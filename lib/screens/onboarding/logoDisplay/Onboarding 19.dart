...
import 'package:finalhealtether/screens/onboarding/logoDisplay/Onboarding%2020.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class onbording19 extends StatefulWidget {
  const onbording19({super.key});

  @override
  State<onbording19> createState() => _onbording19State();
}

class _onbording19State extends State<onbording19> {
  @override
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Image.asset('assets/images/Vector 338.png',height:  543*he,width: 1265*wi,
            ...
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>onbording20()));
