...
import 'package:finalhealtether/screens/Records/staffAccess/AddMember/Addmember_payment_details.dart';
import 'package:flutter/material.dart';

class AddMemberDocuments extends StatefulWidget {
  const AddMemberDocuments({super.key});

  @override
  State<AddMemberDocuments> createState() => _AddMemberDocumentsState();
}

class _AddMemberDocumentsState extends State<AddMemberDocuments> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            SelectIDProof==""?    ' Select ID proof':SelectIDProof,
                                                            ...
                                                            style: TextStyle (
                                                              ...
                                                              color: SelectIDProof=="" ? Color( 0xffa2a2a2) : Color(0xff2c2c2c),
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => AddMemberPaymentDetails()));
                          },
                          child: Container(
                            // buttonsHQ1 (126:5157)
