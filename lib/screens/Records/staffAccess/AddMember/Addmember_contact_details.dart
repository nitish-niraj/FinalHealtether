...
import 'package:finalhealtether/screens/Records/staffAccess/AddMember/Addmember_documents.dart';
import 'package:flutter/material.dart';

class AddMemberContactDetails extends StatefulWidget {
  const AddMemberContactDetails({super.key});

  @override
  State<AddMemberContactDetails> createState() => _AddMemberContactDetailsState();
}

class _AddMemberContactDetailsState extends State<AddMemberContactDetails> {
  @override
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddMemberDocuments()));
                          },
                          child: Container(
                            // buttons9ru (126:5006)
                            padding: EdgeInsets.fromLTRB(
