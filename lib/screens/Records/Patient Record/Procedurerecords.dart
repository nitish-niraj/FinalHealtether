...
class ProcedureRecords extends StatefulWidget {
  ...
  @override
  State<ProcedureRecords> createState() => _ProcedureRecordsState();
}

class _ProcedureRecordsState extends State<ProcedureRecords> {
  var list = [
    listModel(count: 1, title: 'Consultation_01july23.pdf'),
    listModel(count: 2, title: 'Minor surgery_28may23.pdf'),
    listModel(count: 3, title: 'Consultation_01july23.pdf'),
  ];
  @override
