import 'package:finalhealtether/screens/Records/Patient%20Record/EditPatientProfile/EditPatientProfile2.dart';
...
class EditPatientProfile1 extends StatefulWidget {
  const EditPatientProfile1({super.key});

  @override
  State<EditPatientProfile1> createState() => _EditPatientProfile1State();
}

class _EditPatientProfile1State extends State<EditPatientProfile1> {
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>EditPatientProfile2()
                                        ));
                          },
                          child: Container(
                            // buttonsBru (126:4854)
